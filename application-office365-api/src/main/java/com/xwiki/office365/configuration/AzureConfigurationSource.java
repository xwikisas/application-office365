...
@Singleton
@Unstable
public class AzureConfigurationSource extends AbstractWikisConfigurationSource
{
    /**
     * The hint for this component.
     */
    public static final String HINT = "com.xwiki.office365";

    private static final String CLASS_SPACE = "Office365";

    private static final LocalDocumentReference CONFIG_DOC =
        new LocalDocumentReference(CLASS_SPACE, "Office365Config");

    private static final LocalDocumentReference CONFIG_CLASS =
        new LocalDocumentReference(CLASS_SPACE, "Office365ConfigClass");
